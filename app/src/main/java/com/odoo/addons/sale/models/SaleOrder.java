...
public class SaleOrder extends OModel {
    ...
    OColumn payment_term = new OColumn("Termino de Pago", AccountPaymentTerm.class, OColumn.RelationType.ManyToOne);
    ...
    public String getStateTitle(OValues row) {
        ...
        mStates.put("draft", "Cotizacion");
        mStates.put("sent", "Cotizacion enviada");
        mStates.put("cancel", "Cancelada");
        mStates.put("waiting_date", "Esperando programacion");
        mStates.put("progress", "Pedido");
        mStates.put("manual", "Pedido a facturar");
        mStates.put("shipping_except", "Excepcion de envio");
        mStates.put("invoice_except", "Excepcion de factura");
        mStates.put("done", "Terminado");
